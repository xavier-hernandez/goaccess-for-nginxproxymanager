...
COPY /assests/goaccess/goaccess-1.10.2.tar.gz goaccess.tar.gz
...
RUN cp /goaccess-temp/goaccess.tar.gz .
RUN tar --strip-components=1  -xzvf goaccess.tar.gz
RUN sed -i "s/GWSocket<\/a>/GWSocket<\/a> \/ <a href='https:\/\/tiny.one\/xgoan'>GOAN<\/a> <span>v1.1.40<\/span>/" /goaccess/resources/tpls.html
